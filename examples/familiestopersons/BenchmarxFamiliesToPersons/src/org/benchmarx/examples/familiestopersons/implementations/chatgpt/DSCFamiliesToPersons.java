...
import de.tbuchmann.f2p.deepseek.FamilyTreeTransformer;

public class DSCFamiliesToPersons extends BXToolForEMF<FamilyRegister, PersonRegister, Decisions> {
	private ResourceSet set = new ResourceSetImpl();
	private Resource source;
	private Resource target;
	private Resource corr;
	private FamilyTreeTransformer trans;
	...
	private static final String RESULTPATH = "results/Deepseek";

	public DSCFamiliesToPersons() {
	...
	public String getName() {
		return "Deepseek-Coder-V2 Transformation";
	}
	...
	public void initiateSynchronisationDialogue() {
		...
		trans = new FamilyTreeTransformer(source, target);
		trans.transformFamilyToPerson(familiesRoot, personRoot);		
	}
	...
	public void performAndPropagateTargetEdit(Supplier<IEdit<PersonRegister>> edit) {
		edit.get();
		//trans.transformPersonsToFamilies(personRoot, familiesRoot, 
